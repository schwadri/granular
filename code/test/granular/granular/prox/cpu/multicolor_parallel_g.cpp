...
#include <iostream>
#include "multicolor_parallel_g.hpp"
...
multicolor_parallel_g_sor_prox::multicolor_parallel_g_sor_prox(
  ...
  void multicolor_parallel_g_sor_prox::collider_contact_to_solver_contact(
   ...
   *  for a single worker
   */
  void multicolor_parallel_g_sor_prox::setup_bcsr_gij_seq(index_t sub_id, sub_problem & wp, granular_system const & sys) {
  ...
  vec3 multicolor_parallel_g_sor_prox::solve_one_contact_problem_alart_curnier(
  ...
  std::pair<bool, bool> multicolor_parallel_g_sor_prox::work_function(
    ...
    multicolor_parallel_g_sor_prox::prox_worker::prox_worker(
    ...
    void multicolor_parallel_g_sor_prox::prox_worker::operator()() {
    ...
    multicolor_parallel_g_sor_prox::prox_master::prox_master(
                sub_problem const & sub_, std::vector<vec3> & percussions_, index_t percussion_offset_,
    ...
    void multicolor_parallel_g_sor_prox::prox_master::operator()() {
      done      = false;
      converged = true;
      diverged  = false;
      iteration = 0;
  ...
  prox_result multicolor_parallel_g_sor_prox::run() {
  ...
  void multicolor_parallel_g_sor_prox::apply_percussions(granular_system & sys) {
