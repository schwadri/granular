...
#include "chaotic_parallel.hpp"

chaotic_parallel_sor_prox::chaotic_parallel_sor_prox(
...
void chaotic_parallel_sor_prox::insert_into_independent_sets(
...
void chaotic_parallel_sor_prox::build_independent_contact_sets(
...
void chaotic_parallel_sor_prox::collider_contact_to_solver_contact(
...
void chaotic_parallel_sor_prox::distribute_work(
                                                   granular_system const & sys,
                                                   std::vector<collider::contact> const & contacts,
 ...
 *  for a single worker
 */
void chaotic_parallel_sor_prox::setup_bcsr_gij_seq(index_t sub_id, sub_problem & wp, granular_system const & sys) {
...
vec3 chaotic_parallel_sor_prox::solve_one_contact_problem_alart_curnier(
...
bool chaotic_parallel_sor_prox::work_function(
                                                                  sub_problem & sub,
                                                                  index_t & l_i,
                                                                  index_t & g_i,
                                                                  index_t l_end,
...
chaotic_parallel_sor_prox::prox_worker::prox_worker(
...
void chaotic_parallel_sor_prox::prox_worker::operator()() {
  sub.iteration         = 0;
  sub.converged_counter = 0;
  do {
    //start new iteration
...
chaotic_parallel_sor_prox::prox_master::prox_master(std::vector<sub_problem> const & work_,
                                                       sub_problem & sub_, std::vector<vec3> & percussions_, index_t percussion_offset_,
...
void chaotic_parallel_sor_prox::prox_master::operator()() {
  done      = false;
  converged = true;
  diverged  = false;
  iteration = 0;
...
prox_result chaotic_parallel_sor_prox::run() {
...
void chaotic_parallel_sor_prox::setup_contacts(
                                                  granular_system const &                 sys,
                                                  std::vector<collider::contact> const &  contacts,
...
void chaotic_parallel_sor_prox::apply_percussions(granular_system & sys) {
