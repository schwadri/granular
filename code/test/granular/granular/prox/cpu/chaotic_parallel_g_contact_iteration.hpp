//
//  multicolor_parallel_contact_iteration.h
//  granular
//
...
#ifndef granular_chaotic_parallel_contact_iteration_hpp
#define granular_chaotic_parallel_contact_iteration_hpp
...
/** \brief parallel cpu sor prox variant of multicolor parallel without per color thread synchronisation
 ...
 until all his neighbours have the same or a bigger iteration count.
 \note this is also a chaotic gs variant. so convergence might be very bad
 */
struct chaotic_parallel_g_contact_iteration_sor_prox {
  ...
  chaotic_parallel_g_contact_iteration_sor_prox(
