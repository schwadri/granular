...
size_t const      total_size = wg_size;
...
STRINGIFY(
    ...
    __kernel void euler(
      __global float * s, __global float * ds, real_t dt, index_t size
    ) {
...
void updateSys(int it) {
  ...
  global_work_size[0] = total_size * 4;
