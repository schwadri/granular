 ...
 *  \modified $Sun 01 Jul 04:07:18 PM CEST 2012 schwadri@SchwadriBook.local$
 *  \par FIXME
...
namespace core {
    ...
    class time {
    public:
        typedef std::tr1::int64_t sec_type;   ///< the type used to represent seconds
        typedef std::tr1::int64_t nsec_type;  ///< the type used to represend nanoseconds
        sec_type sec;
        nsec_type nsec;
